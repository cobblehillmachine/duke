...
class NS_Widget_MailChimp extends WP_Widget {
	...
	public function widget ($args, $instance) {
		...
		if ((isset($_COOKIE[$this->id_base . 'false' . $this->number]) && $this->hash_mailing_list_id($this->number) == $_COOKIE[$this->id_base . '-' . $this->number]) || false == $this->ns_mc_plugin->get_mcapi()) {
			...
			if ($this->successful_signup) {
				...
				?>	
				<form action="<?php echo $_SERVER['REQUEST_URI']; ?>" id="<?php echo $this->id_base . '_form-' . $this->number; ?>" method="post" class="mc-form">
					...
					?>
						...
						<input id="<?php echo $this->id_base; ?>-email-<?php echo $this->number; ?>" type="text" name="<?php echo $this->id_base; ?>_email" default="JOIN OUR MAILING LIST" class="form-input" />
