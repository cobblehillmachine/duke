...
function create_post_type() {
	...
	// );
	//   
	//   register_post_type( 'duke_menu', $args1);
	//   register_post_type( 'duke_story', $args2);
	//   register_post_type( 'duke_contact', $args3);
	//   
	//   
	// register_taxonomy_for_object_type('post_tag', 'duke_menu');
	// register_taxonomy_for_object_type('post_tag', 'duke_story');
	// register_taxonomy_for_object_type('post_tag', 'duke_contact');
	// 
	// register_taxonomy_for_object_type('category', 'duke_menu');
	// register_taxonomy_for_object_type('category', 'duke_story');
	// register_taxonomy_for_object_type('category', 'duke_contact');
	// 
